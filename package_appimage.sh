...
./linuxdeploy-x86_64.AppImage --appdir AppDir -e ed_highway -i "$REPO_ROOT"/arch_linux/ed_highway.png -d "$REPO_ROOT"/arch_linux/ed_highway.desktop --plugin qt --output appimage

# move built AppImage back into original CWD

mv E:D_Highway*.AppImage "$OLD_CWD/latestx64"