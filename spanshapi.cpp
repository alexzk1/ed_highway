...
void SpanshApi::executeRequest(const std::string &api, const RestClient::parameters &params, callback_t callback)
{
    ...
    const auto executor = [url, eparams, callback](auto)
    {
        try
        {
