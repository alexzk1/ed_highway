...
{
protected:
    using binary_blob = QPair<int, QVector<uint8_t>>; //int is original uncompressed size, compressor need it to unpack
...
public:
    ...
    bool addData(const QString& key, const QString& value, uint32_t valid_for_seconds = ONE_DAY_SECONDS);
